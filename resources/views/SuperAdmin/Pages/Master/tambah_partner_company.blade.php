                      ...
                      <div class="card-body card-block">
                        ...
                        <div class="row form-group">
                          ...
                          <div class="col-12 col-md-9">
                            <select name="category_id" id="category_id" data-placeholder="Silahkan pilih"..." class="standardSelect" tabindex="1">
                              <option value=""></option>
                        ...
                        <div class="row form-group">
                          ...
                          <div class="col-12 col-md-9">
                            <select name="produk_id" id="produk_id" data-placeholder="Silahkan pilih..." class="standardSelect" tabindex="1">
                              <option value=""></option>
