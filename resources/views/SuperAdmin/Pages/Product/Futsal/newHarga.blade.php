                      ...
                      <div class="card-body card-block">
                        <form action="{{route('superadmin.role.save')}}" method="POST" enctype="application/json" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="name" name="name" placeholder="Jadwal ID" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class="form-control-label">Harga</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="name" name="name" placeholder="Harga" class="form-control"></div>
                          </div>
                      </div>
