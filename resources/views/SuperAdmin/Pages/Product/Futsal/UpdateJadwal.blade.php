                      ...
                      <div class="card-body card-block">
                        <form action="{{route('superadmin.futsal.updatejadwal', $editJadwal->id)}}" method="POST" enctype="application/json" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="date" id="tanggal" name="tanggal" value="{{$editJadwal->tanggal}}" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="harga" name="harga" value="{{$editJadwal->harga}}" class="form-control"></div>
                          </div>
                      </div>
